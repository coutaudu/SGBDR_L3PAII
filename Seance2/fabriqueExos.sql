...
-- [1] Prendre en main la BDD
-- Afficher toutes les informations des employés: Nom salaires etc.. nom de service, horaire et nom du chef.

-- [2] Insérer: Clause INSERT INTO
